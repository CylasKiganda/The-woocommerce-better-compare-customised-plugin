...
class WooCommerce_Better_Compare {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-woocommerce-better-compare-my-comparisons.php';
	...
	private function define_public_hooks() {
        ...
        if(isset($_GET['woocommerce-better-compare-share']) && !empty($_GET['woocommerce-better-compare-share'])) {
        	$this->loader->add_action( 'init', $this->plugin_public, 'get_share', 1 );
		}				

		$this->my_comparisons = new WooCommerce_Better_Compare_My_Comparisons( $this->get_plugin_name(), $this->get_version() );
		$this->loader->add_action( 'init', $this->my_comparisons, 'init', 10 );
		$this->loader->add_action( 'wp_ajax_my_comparisons_view', $this->my_comparisons, 'view', 10 );
		$this->loader->add_action( 'wp_ajax_my_comparisons_remove_product', $this->my_comparisons, 'remove_product', 10 );
		$this->loader->add_action( 'wp_ajax_my_comparisons_edit', $this->my_comparisons, 'edit', 10 );
		$this->loader->add_action( 'wp_ajax_my_comparisons_delete', $this->my_comparisons, 'delete', 10 );
		...
		$this->loader->add_action('wp_ajax_nopriv_compare_products_save', $this->my_comparisons, 'save');
        $this->loader->add_action('wp_ajax_compare_products_save', $this->my_comparisons, 'save');
