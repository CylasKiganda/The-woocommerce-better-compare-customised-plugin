...
class WooCommerce_Better_Compare_Widget extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        $compareNow = $woocommerce_better_compare_options['textsCompareNow'];
        $clearAll = $woocommerce_better_compare_options['textsClearAll'];
        $compareProducts = $woocommerce_better_compare_options['textsCompareProducts'];
        $saveComparison = $woocommerce_better_compare_options['textsSaveComparison'];
        $shareComparison = $woocommerce_better_compare_options['textsShareComparison'];
        ...
        $html .= '<div id="woocommerce-compare-sidebar" class="woocommerce-compare-sidebar">';
            ...
            $html .= '<div id="woocommerce-compare-sidebar-items" class="woocommerce-compare-sidebar-items">';
                ...
                $html .= '<div id="woocommerce-compare-sidebar-actions" class="woocommerce-compare-sidebar-actions">';
                    $html .= '<a href="#" id="woocommerce-compare-sidebar-action-clear" class="woocommerce-compare-sidebar-action-clear clear-all-compared-products">' . $clearAll . ' <i class="fa fa-times"></i></a>';
                    $html .= '<a href="' . $compareBarPage . '" id="woocommerce-compare-sidebar-action-compare" class="woocommerce-compare-table-action-compare">' . $compareNow . ' <i class="fa fa-chevron-right"></i></a>';

                    if($woocommerce_better_compare_options['myComparisons'] == "1" && is_user_logged_in()) {
                        $html .= '<br><a href="#" id="woocommerce-compare-bar-action-save-comparison" class="woocommerce-compare-table-action-save-comparison"><i class="fa fa-save"></i> ' . $saveComparison . '</a>';
                    }

                    if($woocommerce_better_compare_options['shareComparison'] == "1") {

                        $html .= do_shortcode('[woocommerce_better_compare_share]');

                        // $html .= '<a href="#" id="woocommerce-compare-bar-action-share-comparison" class="woocommerce-compare-table-action-share-comparison">' . $shareComparison . ' <i class="fa fa-share"></i></a>';
                    }
